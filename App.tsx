    ...
    return (
      <div className="h-screen flex flex-col bg-white">
         <div className="flex-1 flex flex-col px-8 pt-safe-top pb-12 overflow-y-auto">
            <div className="mt-16 mb-8">
               ...
               <h1 className="text-[34px] font-bold tracking-tight text-black leading-tight mb-2">
                 Welcome to<br/>HK Census
               </h1>
               <p className="text-[17px] text-gray-500 leading-relaxed">
                 Securely submit your population data and explore demographic trends in your area through our interactive map.
               </p>
            </div>
            ...
            <div className="space-y-6 mt-4">
                <FeatureRow 
                   ...
                   title="Quick & Easy"
                   desc="Complete your profile in less than 2 minutes."
                />
                <FeatureRow 
                   ...
                   desc="See how your demographics compare to the rest of HK."
                />
            </div>
         </div>
         ...
         <div className="p-8 safe-area-bottom bg-white/90 backdrop-blur-md sticky bottom-0">
            <button 
                onClick={handleStart}
                className="w-full bg-[#007AFF] text-white font-bold text-[17px] py-3.5 rounded-xl shadow-sm ios-active"
            >
                Continue
            </button>
            <div className="flex justify-center mt-4 space-x-4 text-[11px] text-gray-400">
  ...
  if (currentStep === AppStep.ANALYZING) {
      return (
          <div className="h-screen flex flex-col items-center justify-center bg-[#F2F2F7] p-8 text-center">
              ...
              <h2 className="text-[20px] font-bold text-black mb-1">Processing</h2>
              <p className="text-[15px] text-gray-500">Analyzing census data...</p>
          </div>
      )
  }
...
const FeatureRow = ({ icon, title, desc }: any) => (
    <div className="flex items-start space-x-4">
        ...
        <div>
            ...
            <p className="text-gray-500 text-[15px] leading-snug">{desc}</p>
        </div>
    </div>
)
